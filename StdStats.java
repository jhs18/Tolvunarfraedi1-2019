...
public final class StdStats {
     ...
     *
     * @param a the array
     * @return the maximum value in the array {@code a[]}; {@code Double.NEGATIVE_INFINITY} if no
     * such value
     */
     ...
     *
     * @param a the array
     * @return the maximum value in the array {@code a[]}; {@code Integer.MIN_VALUE} if no such
     * value
     */
     ...
     *
     * @param a the array
     * @return the minimum value in the array {@code a[]}; {@code Double.POSITIVE_INFINITY} if no
     * such value
     */
     ...
     *
     * @param a the array
     * @return the minimum value in the array {@code a[]}; {@code Integer.MAX_VALUE} if no such
     * value
     */
     ...
     * @param lo the left endpoint of the subarray (inclusive)
     * @param hi the right endpoint of the subarray (exclusive)
     * @return the population standard deviation in the subarray {@code a[lo..hi)}; {@code
